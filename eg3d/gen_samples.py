...
def generate_images(
    ...
    # python gen_videos.py --outdir=./ --trunc=0.7 --interpolate False --sample_mult 2 --network=./~/training-runs/00005-ffhq-FFHQ_recrop_anime-gpus2-batch8-gamma1/network-snapshot-000400.pkl --seeds=100
    """
