...
from .FaceDataset_ws import FaceDataset_ws
from .FaceDataset_ws_256 import FaceDataset_ws_256
from .FaceDataset_ws_anime import FaceDataset_ws_anime
...
def get_split_dataset(dataset_type, datadir, want_split="all", training=True, **kwargs):
    ...
    if dataset_type == "srn":
        ...
        dset_class = FaceDataset
    elif dataset_type == "face_ws":
        dset_class = FaceDataset_ws
    elif dataset_type == "face_ws_256":
        dset_class = FaceDataset_ws_256
    elif dataset_type == "face_ws_256_img":
        dset_class = FaceDataset_ws_256_img
    elif dataset_type == "FaceDataset_ws_anime":
        dset_class = FaceDataset_ws_anime
