...
class Trainer:
    def __init__(self, net, train_dataset, test_dataset, args, conf, device=None):
        ...
        self.optim = torch.optim.Adam(list(net.planes_conv.parameters()) + list(net.sketch_encoder.parameters()), lr=args.lr)
        if args.gamma != 1.0:
        ...
        if args.resume:
            ...
            #print("net state path:", self.default_net_state_path)
