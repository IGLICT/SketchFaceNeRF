...
args, conf = util.args.parse_args(extra_args, training=True, default_ray_batch_size=2048)
...
class PixelNeRFTrainer(trainlib.Trainer):
    def __init__(self):
        ...
        #print("render state path:", self.renderer_state_path)
        if args.resume:
...
#python train/train.py -n srn_car_exp -c conf/exp/srn.conf -D ./dataset/srn_cars/cars --gpu_id=1 --name car_lfl --resume
#python train/train.py -n face_small_exp -c conf/exp/face.conf -D /mnt/16T/liufenglin/dataset/pixel_nerf/small --gpu_id=1 --name face_small --no_bbox_step 0 --resume
#python train/train.py -n face_small_exp -c conf/exp/face.conf -D /mnt/16T/liufenglin/dataset/pixel_nerf/FFHQ --gpu_id=1 --name face_30000 --no_bbox_step 0 --batch_size 32
#python train/train.py -n face_small_exp -c conf/exp/face.conf -D /home/liufenglin/210_16T/dataset/pixel_nerf/FFHQ --gpu_id=2 --name face_30000 --no_bbox_step 0 --batch_size 32

##python train/train.py -n face_small_exp -c conf/exp/face_1.conf -D /mnt/16T/liufenglin/dataset/pixel_nerf/FFHQ --gpu_id=1 --name face_small_net --no_bbox_step 0 --batch_size 2
#python train/train.py -n face_small_exp_1 -c conf/exp/face_1.conf -D /mnt/16T/liufenglin/dataset/pixel_nerf/FFHQ --gpu_id=1 --name face_small_net_sketch --no_bbox_step 0 --batch_size 2

#python train/train.py -n face_net_fea -c conf/exp/face_1_fea.conf -D /home/liufenglin/20_16T/dataset/pixel_nerf/FFHQ --gpu_id=1 --name face_net_fea --no_bbox_step 0 --batch_size 4
